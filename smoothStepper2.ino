int dt;
const double startFreq = 200;      //in Hz, min value of 62 Hz by precision of delayMicroseconds
const double maxFreq = 720;      //in Hz, max value value of 330 kHz precision of delayMicroseconds
