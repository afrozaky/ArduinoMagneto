 ...
 *  then decelerates it back to a minimum frequency. tThen it changes the direction of rotation and repeats the sequence.
 */

// DECLARING CONSTANTS
const double startFreq = 250;                                           // [Hz] min value of 62 Hz by precision of delayMicroseconds
const double maxFreq = 4000;                                            // [Hz] max value of 330 kHz by precision of delayMicroseconds
...
const double df = 45;                                                  // [Hz] frequency increments
